            ...
            if (drawable_sprite != null)
            {
                ...
                byte[] bytes = texture.EncodeToPNG();
                    ...
                    //    BEGIN Texturing 
                        ...
                        PenTool.penTool.newVertices = new List<UpdateAll>();
                        PenTool.penTool.textureVertices = new Vector3[globalMesh.vertices.Length];

                        uv = new List<Vector2>();
                        for (int i = 0; i < globalMesh.vertices.Length; i++){
                            pointsMimo[i] = new UpdateAll( i , globalMesh.vertices[i] );
                            PenTool.penTool.newVertices.Add(pointsMimo[i]);
                        ...
                        globalMesh.vertices = PenTool.penTool.textureVertices;
